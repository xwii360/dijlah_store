...
class HelperCenter extends StatefulWidget {
  final BLoC bLoC;

  const HelperCenter({Key key, this.bLoC}) : super(key: key);

  @override
  _HelperCenterState createState() => _HelperCenterState();
}

class _HelperCenterState extends State<HelperCenter> {
  final GlobalKey<FormState> _form = GlobalKey<FormState>();
  String _name, _email, _problem, _phone;
  ...
  var selectedSupportType='problem';
  var status;
 var helpType=["problem","enquiry","complaint","other"];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: appBarTitle(getTranslated(context, "helper_center")),
        titleSpacing: 0.0,
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Text(
                  getTranslated(context, "helper_center_title"),
                  style: TextStyle(
            ...
            Form(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(getTranslated(context, "complaint_type"),
                      style: TextStyle(
                        fontWeight: FontWeight.w500,
                        fontSize: SizerUtil.deviceType == DeviceType.tablet
                            ? 6.sp
                  ...
                  TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText:getTranslated(context, selectedSupportType),
                        hintStyle:
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      validator: (input) {
                        if (input.isEmpty) {
                          return getTranslated(
                              context, "complaint_feild_is_required");
                        }
                      },
                      maxLines:
                          SizerUtil.deviceType == DeviceType.tablet ? 8 : 6,
                      ...
                      decoration: InputDecoration(
                        ...
                        contentPadding: EdgeInsets.only(
                            ...
                            bottom: SizerUtil.deviceType == DeviceType.tablet
                                ? 20
                                : 13),
                        hintText: getTranslated(context, "complaint_hint"),
                        hintStyle: TextStyle(
                          fontFamily: "sans",
                          fontSize: SizerUtil.deviceType == DeviceType.tablet
                              ? 6.sp
                  ...
                  InkWell(
                        ...
                        checkInternet(context).then((value) async {
                          if (value == 'ok') {
                            ...
                            if (emailValid == true) {
                              ...
                              await insertCallUs().then((value) =>  setState(() {
                                      loading=false;
                              }));
                              if (status == true) {
                                setState(() {
                                ...
                                showTopFlash(
                                    ...
                                    "",
                                    getTranslated(
                                        context, "helper_center_successfully"),
                                    false);
                              ...
                              showTopFlash(
                                  context,
                                  "",
                                  getTranslated(context, "wrong_email_format"),
                                  true);
                            }
                          }
                        });
                    ...
                    child: Container(
                      height:
                          SizerUtil.deviceType == DeviceType.tablet ? 70 : 52.0,
                      width: double.infinity,
                      decoration: BoxDecoration(
                          color: color1,
                          borderRadius:
  ...
  Future<bool> insertCallUs() async {
    ...
    Map<String, String> body = {
      ...
      'type': selectedSupportType.toString(),
    };
          ...
          return Column(
            ...
            children: <Widget>[
              Stack(children: [
                 ListTile(
                  title: Text(
                  getTranslated(context, 'choose_help_type') ,
                      ...
                      children:helpType.map((e)  =>
                          ListTile(
                              ...
                              title: Container(
                                ...
                                decoration: BoxDecoration(
                                    border: Border.all(color: selectedSupportType==e?Theme.of(context).primaryColor:Colors.grey[300],width:  selectedSupportType==e?1.5:1)),
                                child: Row(
                                  children: [
                                    Text(
